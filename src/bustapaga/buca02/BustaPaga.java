...
public class BustaPaga {
    ...
    public double getTasse() {
        ...
        return imponibile - getNetto(primoScaglione, secondoScaglione, terzoScaglione);
    }

    private static double getNetto(double primoScaglione, double secondoScaglione, double terzoScaglione) {
