...
public class BustaPaga {
    ...
    public double getNetto() {
        ...
        return imponibile - getTasse(primoScaglione, secondoScaglione, terzoScaglione);
    }

    private static double getTasse(double primoScaglione, double secondoScaglione, double terzoScaglione) {
